...
class PentairAuth {
    ...
    async fetchTokens() {
        ...
        const { signature, timestamp } = this.computePasswordVerifierProof(a, A, salt, srpB, secretBlock, userId);
    ...
    // ---------------------------------------------------------------------------
    computePasswordVerifierProof(a, A, salt, srpB, secretBlock, userId) {
